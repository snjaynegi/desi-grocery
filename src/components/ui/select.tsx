...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-green-100 focus:text-green-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-green-900 dark:focus:text-green-50",
      className
    )}
    {...props}
  >
